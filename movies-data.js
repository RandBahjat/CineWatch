...
window._MOVIES_DATA = [
  {
    ...
    overviewKurdish:" کوڕی پیاوێکی بێوەژن ون دەبێت لە شارۆچکەیەک کە ڕۆخص کوشەرێکی زنجیرەیی، پیاوی چرپە،تۆقاندبووی. ڕوو لە باوکی لێدوورکەوتووی خۆی دەکات، پۆلیسێکی خانەنشین، کەیسی کۆن هەڵدەکۆڵنەوە کە ئێستا تێکەڵ دەبێت لەگەڵ تاوانێکی نوێ.",

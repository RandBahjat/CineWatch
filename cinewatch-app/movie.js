...
let TRENDING_THIS_WEEK_SERIES = ["Spider-Man: Brand New Day","MobLand (The Donovans)", "Reacher","Star Trek: Strange New Worlds", "Slow Horses", "Lanterns", "The Gentlemen", "Silo", "One Piece", "Ted Lasso","Last Seen", "X-Men '97", "Lioness", "Outer Banks"];
const POPULAR_MOVIES = ["Coyote vs. Acme","Mayday","Moana(2026)","Batman: Knightfall Part 1: Knightfall", "Mutiny", "The Odyssey", "The Runner", "Obsession", "Spider-Man: No Way Home","Backrooms", "Disclosure Day", "The Death of Robin Hood", "The Last House","Drawn Together","The End of Oak Street", "Michael", "Project Hail Mary","Avatar Aang: The Last Airbender","The Shawshank Redemption"];

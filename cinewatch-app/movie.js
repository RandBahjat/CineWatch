...
// ==========================================
let FEATURED_TITLES = ["The Runner","Coyote vs. Acme","Just Play Dead","The Whisper Man","Grand Theft Auto VI: An Extended Look","Mousetrap","Batman: Knightfall Part 1: Knightfall", "Mutiny", "Reacher", "Lanterns", "Lioness", "Spider-Man: Brand New Day", "The Last Sunrise", "The Odyssey", "Obsession", "The Last House"];
let TOP_10_TRENDING_TODAY = ["Just Play Dead","Grand Theft Auto VI: An Extended Look","Motor City", "Mutiny", "Batman: Knightfall Part 1: Knightfall","Reacher", "The Last Sunrise", "Spider-Man: Brand New Day", "Lanterns", "The Odyssey"];

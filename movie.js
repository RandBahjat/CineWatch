...
const VIP_WALLETS = {
  ...
  fastpay: {
    ...
    color: "#e11d48",
    logoSvg: '<svg viewBox="0 0 32 32" width="20" height="20" fill="none" style="display:block;"><rect width="32" height="32" rx="7" fill="#E11D48"/><path d="M9 8h14a1 1 0 0 1 1 1v2.6a1 1 0 0 1-1 1h-8.2v3.4h6.5a1 1 0 0 1 1 1v2.6a1 1 0 0 1-1 1h-6.5V25H9a1 1 0 0 1-1-1V9a1 1 0 0 1 1-1z" fill="#FFFFFF"/></svg>'
  },
  zaincash: {
    name: "ZainCash",
    ...
    color: "#059669",
    logoSvg: '<svg viewBox="0 0 32 32" width="20" height="20" fill="none" style="display:block;"><rect width="32" height="32" rx="7" fill="#059669"/><path d="M8.5 9h15v3.2L12.5 20.8H24V24H8.5v-3.2L19.5 12.2H8.5V9z" fill="#FFFFFF"/></svg>'
  },
  fib: {
    ...
    color: "#2563eb",
    logoSvg: '<svg viewBox="0 0 32 32" width="20" height="20" fill="none" style="display:block;"><rect width="32" height="32" rx="7" fill="#1E40AF"/><text x="16" y="21" font-family="\'Inter\', -apple-system, BlinkMacSystemFont, sans-serif" font-weight="900" font-size="11.5" fill="#FFFFFF" text-anchor="middle" letter-spacing="-0.5">FIB</text></svg>'
  }
};

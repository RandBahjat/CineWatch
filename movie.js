...
// ==========================================
let FEATURED_TITLES = ["Mayday","The Runner","Coyote vs. Acme","Just Play Dead","Reacher","The Whisper Man","Grand Theft Auto VI: An Extended Look" ,"Batman: Knightfall Part 1: Knightfall", "Mutiny", "Lanterns", "Lioness", "Spider-Man: Brand New Day", "The Last Sunrise", "The Odyssey"];
...
let TRENDING_THIS_WEEK_MOVIES = ["The Runner","Batman: Knightfall Part 1: Knightfall", "Mutiny", "Spider-Man: Brand New Day", "The Odyssey", "Motor City", "Toy Story 5", "Obsession", "Minions & Monsters", "The Last House", "Disclosure Day", "The Invite", "The End of Oak Street", "Backrooms", "Camp Rock 3", "Evil Dead Burn", "Just Play Dead"];

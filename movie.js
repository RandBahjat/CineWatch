...
// ==========================================
let FEATURED_TITLES = ["Mutiny","Reacher", "Lanterns", "House of the Dragon", "The Invite", "Spider-Man: Brand New Day", "The Odyssey", "Obsession", "The Last House", "Silo"];
let TRENDING_THIS_WEEK_MOVIES = ["Mutiny","Spider-Man: Brand New Day", "The Odyssey", "Motor City","Obsession", "Minions & Monsters", "The Last House", "Disclosure Day", "The Invite", "The End of Oak Street", "Backrooms", "Camp Rock 3", "Evil Dead Burn", "Project Hail Mary", "Supergirl"]; // Add titles here for 'Trending Movies This Week'
...
function translateGenre(genre) {
  ...
  if (isSorani) {
    if (genre === 'Fantasy') return 'فانت ەسی';

...
let TOP_10_TRENDING_TODAY = ["Motor City","Reacher","Batman: Knightfall Part 1: Knightfall", "Lanterns", "Spider-Man: Brand New Day", "The Odyssey", "Mutiny", "The Odyssey", "Motor City", "Toy Story 5", "Obsession", "Reacher"];
...
function createMovieCardHTML(movie, rank = null) {
  ...
  const rankHtml = rank !== null ? `<div class="top10-rank-badge"><ion-icon name="trending-up-outline"></ion-icon> TOP ${rank}</div>` : "";
